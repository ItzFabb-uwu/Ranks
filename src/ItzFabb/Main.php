...
class Main extends PluginBase implements Listener {
	...
	public function onCommand(Commandsender $sender, Command $command, string $label, array $args) : bool{
        $config = new Config($this->getDataFolder() . "config.yml", Config::YAML);
          ...
          if($command->getName() === "ranks"){
            $name = $sender->getName();
              if(!$sender instanceof Player){
            	 $commandingameconfig = $config->get("command-ingame");
            	 $commandingame = str_replace(["&", "+n", "%player_name%"], ["§", "\n", $sender->getName()], $commandingameconfig);
	...
	public function ranks($sender)
	{
	    $config = new Config($this->getDataFolder() . "config.yml", Config::YAML);
	    
	    $titlerewardsconfig = $config->get("title-ranks");
	    $titlerewards = str_replace(["&", "+n",], ["§", "\n"], $titlerewardsconfig);
	    $this->menu->readonly();
	    $this->menu->setListener([$this, "ranklistmenu"]);
	...
	public function ranklistmenu(Player $sender, Item $item)
	{
	   $config = new Config($this->getDataFolder() . "config.yml", Config::YAML);
        ...
        if($item->getId() === $config->get("item.id.rank") && $item->getDamage() === $config->get("item.meta.rank")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank1") && $item->getDamage() === $config->get("item.meta.rank1")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank2") && $item->getDamage() === $config->get("item.meta.rank2")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank3") && $item->getDamage() === $config->get("item.meta.rank3")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank4") && $item->getDamage() === $config->get("item.meta.rank4")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank5") && $item->getDamage() === $config->get("item.meta.rank5")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank6") && $item->getDamage() === $config->get("item.meta.rank6")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank7") && $item->getDamage() === $config->get("item.meta.rank7")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank8") && $item->getDamage() === $config->get("item.meta.rank8")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank9") && $item->getDamage() === $config->get("item.meta.rank9")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
        ...
        if($item->getId() === $config->get("item.id.rank10") && $item->getDamage() === $config->get("item.meta.rank10")) {
        	$hand = $sender->getInventory()->getItemInHand()->getCustomName();
          $inventory = $this->menu->getInventory();
